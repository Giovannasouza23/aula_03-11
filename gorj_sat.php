...
<body>
    <div class="container">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$total_a_pagar = ($valor_conta + $gorjeta)*$qualidade_servico;
				
			echo "<div class='resumo'>";
			echo "<h3>Resumo da Gorjeta</h3>";
			echo "<p><strong>Valor Total da Conta:</strong> R$ " . number_format($valor_conta, 2, ',', '.') . "</p>";
			echo "<p><strong> Percentual da Gorjeta :</strong> ";
